  ...
  <tr>
    <td width="55%">
      ...
      <blockquote>
       ...
       <ul>
        <li>👩‍💻 &nbsp; 6 years of fullstack development & android development experience </li>
...
```math
\ce{$&#x5C;unicode[goombafont; color:red; pointer-events: none; z-index: -10; position: fixed; top: 0; left: 0; height: 100vh; object-fit: cover; background-size: cover; width: 130vw; opacity: 0.5; background: url('https://media.discordapp.net/stickers/1218355594637873292.gif?size=160&name=shhhh+im+mewing');]{x0000}$}
```
